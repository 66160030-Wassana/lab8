...
class Blog {
    ...
    getFormattedDate() {
        return this.updateDate.toLocaleDateString("th-TH", {
            year: "numeric",
            month: "long",
            day: "numeric",
            hour: "2-digit",
...
// BlogManager Class - จัดการ array ของ block
class BlogManager {
    constructor() {
        this.blogs = [];
    }
    ...
    sortBlogs() {
        this.blog.sort((a, b) => b.updateDate - a.updateDate);
    }
}
...
class BlogUI {
    ...
    editBlog(id) {
        ...
        if (blog) {
            ...
            this.formTitle.textContent = "แก้ไชบล็อค";
    ...
    deleteBlog(id) {
        if (confirm("ต้องการลบบล็อคนี้ใช่หรือไม่?")) {
    ...
    resetForm() {
        ...
        this.formTitle.textContent = "เขียนบล็อคใหม่";
